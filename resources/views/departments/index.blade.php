                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" aria-label="Basic example">
                                        <a type="button" href="{{ route('departments.edit', $department->id) }}" class="btn btn-warning">Edit</a>
                                        <form onclick="return confirm('Are you sure to delete this department?')" method="POST" action="{{ route('departments.destroy', $department->id) }}">
                                            @csrf
                                            @method('DELETE')
