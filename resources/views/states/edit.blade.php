...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('states.update', $state->id) }}">
                        ...
                        <div class="row mb-3">
                            <label for="state_code" class="col-md-4 col-form-label text-md-end">{{ __('Country') }}</label>
            ...
            <div class="mt-1">
                <form onclick="return confirm('Are you sure to delete this states?')" method="POST" action="{{ route('states.destroy', $state->id) }}">
                    @csrf
                    @method('DELETE')
