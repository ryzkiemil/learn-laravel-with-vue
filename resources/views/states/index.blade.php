                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" aria-label="Basic example">
                                        <a type="button" href="{{ route('states.edit', $state->id) }}" class="btn btn-warning">Edit</a>
                                        <form onclick="return confirm('Are you sure to delete this state?')" method="POST" action="{{ route('states.destroy', $state->id) }}">
                                            @csrf
                                            @method('DELETE')
